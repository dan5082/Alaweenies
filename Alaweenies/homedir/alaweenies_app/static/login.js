...
$(function () {
    ...
    $('#signUpButt').click(function () {
        ...
        var firstNameArea = $("#firstNameArea");
        firstNameArea.append('<label for="firstName">First Name</label>');
        firstNameArea.append('<input type="email" class="form-control" id="firstNameInput" aria-describedby="emailHelp" placeholder="Taylor" required>');
        loginBox.append('</div>');
